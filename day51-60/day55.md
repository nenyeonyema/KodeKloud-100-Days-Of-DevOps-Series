...
### Sidecar pattern:  Create two containers(A main container that serves webpages and read logs and a sidecar container that reads the logs and ships them).
