...
### Kubernetes Guestbook App (Redis master + Redis slave + Frontend).
All requirements from the BACK-END and FRONT-END tiers are fully implemented.

1. Guestbook App
All in one Yaml file (guestbook.yml)
```
# --------------------------
