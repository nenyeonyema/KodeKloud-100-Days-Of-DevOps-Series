...
1. Update website content (Gitea)

Login to Storage Server (NOT Jenkins):
...
```
git add index.html
git commit -m "Updated welcome message for xFusionCorp"
...
Scroll to Pipeline → Definition → Pipeline script and paste:
